...
The next part of the story shifts from everyday essentials to the cost of education itself. Using the Average Total Cost of Attendance for 4-Year Institutions (Off-campus, Not Living with Family) visualization, I illustrate how tuition and student expenses have risen across all institutions — public, private nonprofit, and private for-profit.

While the timeframe available from NCES is shorter, the pattern is unmistakable:
education costs continue trending upward, adding another layer to the financial challenge students face today.
